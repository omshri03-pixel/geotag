...
const deployStartStr = '{/* ==================== COMPASS ORBIT DIAL (SECTION 5: DEPLOYMENT TIERS) ==================== */}';
const deployStartIndex = content.indexOf(deployStartStr);

if (deployStartIndex !== -1) {
    const nextSectionStr = '{/* ==================== SCALE MAP LISTINGS: PRICING (SECTION 6) ==================== */}';
    const nextSectionIndex = content.indexOf(nextSectionStr);
    
    const newDeploy = `      {/* ==================== COMPASS ORBIT DIAL (SECTION 5: DEPLOYMENT TIERS) ==================== */}
      <section id="deployments" className="py-24 px-4 sm:px-6 lg:px-8 w-full relative z-10 bg-[#DEDEDE]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center w-full">
          ...
          <div className="col-span-1 lg:col-span-6 flex items-center justify-center relative py-8 lg:py-0 w-full overflow-hidden">
          ...
          <div className="col-span-1 lg:col-span-6 text-left space-y-8 w-full">
...
`;
    ...
    content = content.substring(0, deployStartIndex) + newDeploy + content.substring(nextSectionIndex);
}

fs.writeFileSync('./src/app/page.tsx', content, 'utf8');
console.log("Deployments successfully hard-coded to perfect gray contrast layout.");
